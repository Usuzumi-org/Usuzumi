...
for (const expected of ['menu:rename', 'context:open', 'menubar:edit', 'command:theme', 'combobox:tree', 'grid-sort:ascending', 'grid-select:alpha', 'grid-all:2', 'plain-grid-select:2', 'tree-toggle:false', 'split:58', 'resizable', 'editor:bold', 'editor-change', 'markdown-editor-change', 'markdown-editor', 'markdown-shell-change', 'inline-editor', 'form:false', 'form:true', 'accordion:true', 'step-nav:review', 'hover:open', 'tag:false', 'tag-close:filter']) {
