...
if (value.languageUrlHashAfterSelect !== '#language-url-en' || value.languageUrlRootValue !== 'en' || value.languageUrlRootHtmlLang !== 'en') throw new Error(`Browser consumer language URL strategy did not apply language state and navigation: ${JSON.stringify({ hash: value.languageUrlHashAfterSelect, language: value.languageUrlRootValue, html: value.languageUrlRootHtmlLang })}`);
