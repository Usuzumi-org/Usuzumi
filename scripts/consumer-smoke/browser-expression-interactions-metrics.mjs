...
const editorMountProseMirror = getComputedStyle(editorMount.querySelector('.ProseMirror'));
const editorMountCode = getComputedStyle(editorMount.querySelector('.ProseMirror code'));
